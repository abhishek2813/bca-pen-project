    ...
    <div class="supreme-product">
        ...
        <div class="product-container">
            ...
            <div class="product-desc">
                ...
                <h1><?php echo $row['p_name'] ?></h1>
                    ...
                    <p>Brand: <?php echo find_brand($conn,$row['brand_id']); ?></p><br>

                    <h2>Price: ₹<?php echo $row['price']; ?></h2><br>
                    <p>
     ...
     <div class="product-down">
         ...
         <div class="product-down-inside">
             ...
             <h1>Delivery</h1><br>
             <p>We only provide cash on delivery on every items. Our main motive is to earn customer trust first .Our project is on first phase so we could include other payment options. </p>
